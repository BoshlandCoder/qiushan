...
<div id="wrapper" class="body wrap-lg">
    <div class="" id="mainContent">
		...
		<s:elseif test="null==#session.userDetial||#session.userDetial.isEmpty()">
			 <form id="dd" class="body wrap-lg" method="post" action="sellerCompleteInf.action?user_id=${user.id}&flag=0" novalidate="novalidate" onsubmit="return check()">
                <div class="detailWrapper">
                    ...
                    <div class="rowsWrapper" display="block">
                        <div class="rowItem">
                            ...
                            <input id="address" name="sellerDetial.address" class="input-w200" type="text" aria-required="true" aria-invalid="false">
                            <label id="address-error" class="textWarning" for="address" style="display: none;"></label>
                            <p class="textWarning"></p>
                        </div>
                        <div class="rowItem">
                            <span class="labelName">年龄</span>
                            <input id="age" name="sellerDetial.age" maxlength="20" class="input-w200" type="text" aria-required="true" aria-invalid="false">
                            <label id="age-error" class="textWarning" for="age" style="display: none;"></label>
                            <p class="textWarning"></p>
                        </div>
                        <div class="rowItem">
                            <span class="labelName">邮箱</span>
                            <input id="email" name="sellerDetial.email" class="input-w200" type="text" aria-required="true" aria-invalid="false">
                            <label id="email-error" class="textWarning" for="email" style="display: none;"></label>
                            <p class="textWarning"></p>
                        </div>
                        <div class="rowItem">
                            <span class="labelName">身份证号</span>
                            <input id="idcard" name="sellerDetial.idcard" maxlength="20" class="input-w200" type="text" aria-required="true" aria-invalid="false">
                            <label id="idcard-error" class="textWarning" for="idcard" style="display: none;"></label>
                            <p class="textWarning"></p>
                        </div>
                        <div class="rowItem">
                            <span class="labelName">真实姓名</span>
                            <input id="name" name="sellerDetial.name" maxlength="20" class="input-w200" type="text" aria-required="true" aria-invalid="false">
                            <label id="name-error" class="textWarning" for="name" style="display: none;"></label>
                            <p class="textWarning"></p>
                        </div>
                        <div class="rowItem">
                            <span class="labelName">联系人电话</span>
                            <input id="phone" name="sellerDetial.phone" maxlength="20" class="input-w200" type="text" aria-required="true" aria-invalid="false">
                            <label id="phone-error" class="textWarning" for="phone" style="display: none;"></label>
                            <p class="textWarning"></p>
                        </div>
                        <div class="rowItem">
                            <span class="labelName">性别</span>
                            男<input id="sex_0" name="sellerDetial.sex" type="radio" value="0"> 女<input id="sex_1" name="sex" type="radio" value="1">
        ...
        <s:else>
    		<form id="mainForm" class="body wrap-lg" method="post" action="sellerCompleteInf.action?user_id=${sessionScope.userDetial.id}&flag=1" novalidate="novalidate" onsubmit="return check()">
                <div class="detailWrapper">
                    <div class="solidLine"></div>
                    <div class="titleBar">设置您的资质信息</div>
                    <p class="textMuted">上传资质信息，建立我们和住户对您的信任。</p>
                    ...
                    <div class="terms" id="agreement">
                        <label style="cursor:pointer;"><input id="a" name="agreementCheck" type="checkbox" class="valid" aria-invalid="false">我已阅读并同意遵守协议内容</label>
                        <span id="china-agreement">
                    	<a href="#" class="text-standOut" target="_blank"> 《QS商户服务协议》 &nbsp;</a>
                    	<a href="#" class="text-standOut ml10" target="_blank">  《QS商家入驻标准》 &nbsp;</a>
                    	<a href="#" class="text-standOut ml10" target="_blank"> 《QS预订服务条款》 &nbsp;</a>
