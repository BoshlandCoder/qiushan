...
if ($.fn.datagrid){
	...
	$.fn.datagrid.defaults.rownumberWidth=42;
	$.fn.combogrid.defaults.rownumberWidth=42;
}
...
$.extend($.fn.tabs.defaults,{tabHeight:46,border:false});//tabs宽度更改
$.extend($.fn.textbox.defaults,{height:36});
$.extend($.fn.passwordbox.defaults,{height:36});
$.extend($.fn.combo.defaults,{height:36});
$.extend($.fn.combobox.defaults,{height:36});
$.extend($.fn.combogrid.defaults,{height:36});
$.extend($.fn.combotree.defaults,{height:36});
$.extend($.fn.combotreegrid.defaults,{height:36});
